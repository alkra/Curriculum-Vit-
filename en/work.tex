...
\newcommand\tuwiendate{May -- Novembre 2016}
\newcommand\tuwiencont{%
  6-month \work{Internship}:
  ``Making a client side web application on smartphone''
...
\newcommand\tuwienlong{%
  ...
  \item documented and published problems encountered and solutions
    provided
  \end{itemize}
}
